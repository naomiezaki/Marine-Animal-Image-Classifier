...
TEST_IMAGES_DIR = config.path['test_data_path']
        ...
        for fileName in os.listdir(TEST_IMAGES_DIR):
            ...
            for prediction in sortedPredictions:
                ...
                if onMostLikelyPrediction:
                    ...
                    resultsText = strClassification + ", "
                    confidenceText = "{0:.2f}".format(scoreAsAPercent) + "% confidence"
                    writeResultOnImage(openCVImage, resultsText, confidenceText)
...
#######################################################################################################################
def writeResultOnImage(openCVImage, resultText, confidenceText):
    ...
    print(imageHeight, imageWidth, sceneNumChannels)
    ...
    resultTextUpperLeftTextOriginY = int(imageHeight * 0.00005)
    confidenceTextUpperLeftTextOriginY = int(imageHeight * 0.1)
    ...
    resultTextLowerLeftTextOriginY = resultTextUpperLeftTextOriginY + textSizeHeight
    confidenceTextLowerLeftTextOriginY = confidenceTextUpperLeftTextOriginY + textSizeHeight

    # write the text on the image
    cv2.putText(openCVImage, resultText, (lowerLeftTextOriginX, resultTextLowerLeftTextOriginY), fontFace, fontScale, SCALAR_BLUE, fontThickness)
    cv2.putText(openCVImage, confidenceText, (lowerLeftTextOriginX, confidenceTextLowerLeftTextOriginY), fontFace, fontScale, SCALAR_BLUE, fontThickness)
# end function
